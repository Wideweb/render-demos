...
const Shader::Property& Material::getProperty(const std::string& name) const { return m_Properties.getValue(name); }

const std::vector<std::string>& Material::keys() const { return m_Properties.keys(); }

const std::vector<Shader::Property>& Material::properties() const { return m_Properties.values(); }

bool Material::empty() const { return m_Properties.empty(); }
